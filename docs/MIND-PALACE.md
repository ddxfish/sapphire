...
- Library: library / read_document / memory_save_image(source, topic, caption?, private_key?) — any image (img:<id>, doc:<N>, path, URL) into the library; core image_view("doc:N") shows one; import: import_v2
