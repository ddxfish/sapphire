...
- **`event`** games poke moments: `ctx.poke("Wave 12 cleared. Castle 40/100.")`. She gets a turn no sooner than the min gap after her last one. The note is what she reads.
